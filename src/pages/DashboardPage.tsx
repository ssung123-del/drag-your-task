    ...
    return (
        <div className="p-4 space-y-8 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white p-5 rounded-3xl shadow-lg shadow-gray-100 border border-gray-100 flex flex-col justify-between h-36 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-500">방문심방</span>
                    </div>
                    <span className="text-4xl font-bold tracking-tighter text-gray-900">{stats.visit}</span>
                </div>
                ...
                <div className="bg-white p-5 rounded-3xl shadow-lg shadow-gray-100 border border-gray-100 flex flex-col justify-between h-36 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-500">카페심방</span>
                    </div>
                    <span className="text-4xl font-bold tracking-tighter text-gray-900">{stats.cafe}</span>
                </div>
                ...
                <div className="bg-white p-5 rounded-3xl shadow-lg shadow-gray-100 border border-gray-100 flex flex-col justify-between h-36 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-500">전화심방</span>
                    </div>
                    <span className="text-4xl font-bold tracking-tighter text-gray-900">{stats.phone}</span>
                </div>
            ...
            <div>
                <div className="flex justify-between items-center mb-4 px-1">
                    <h3 className="text-xl font-bold text-gray-900">📋 주간 기록 ({weekEntries.length})</h3>
                ...
                <div className="space-y-4">
                    {weekEntries.length === 0 ? (
                        <div className="flex flex-col items-center justify-center p-12 text-gray-400 bg-white rounded-3xl border-2 border-dashed border-gray-100">
                            ...
                            <span className="font-medium text-gray-500">이번 주 기록이 없습니다.</span>
                        </div>
                    ) : (
                        weekEntries.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).map(entry => (
                            <div key={entry.id} className="bg-white p-5 rounded-3xl shadow-lg shadow-gray-100/50 border border-gray-100 flex flex-col gap-3 transition-transform active:scale-[0.98]">
                                ...
                                <p className="text-gray-800 text-base font-medium leading-relaxed pl-1">
                                    {entry.content}
                                </p>
                            </div>
                        ))
